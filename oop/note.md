...
- super
    ...
    - super与父类直接没任何实质性的关系,但通过super可以调用到父类
...
- 属性操作相关
    ...
    - '__setattr__': 对成员属性进行设置的时候触发
        ...
        - 注意:在该方法中不能对属性进行直接赋值操作,否则进入死循环,参看案例
- 运算分类相关魔术方法
